...
export default function StyledCalendar({ imageUrl, mood }) {
  ...
  return (
    <div className="calendar">
      <div ref={calendarRef} className="calendar__frame">

          <div className='border-4 border-[#d4c4a2] px-8 py-2'>
            <div className="calendar__header">{year}年 {month}월</div>
            <img src={imageUrl} alt="styled" className="calendar__image" />
      ...
      <button onClick={handleDownload} className="calendar__download-btn">이미지 저장</button>
    </div>
  );
}